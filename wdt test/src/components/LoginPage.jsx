...
export default function LoginPage({ onLogin }) {
  ...
  return (
    <div style={{
      ...
      {/* Mobile-only right panel — shown on mobile */}
      <div style={{
        width: "100%",
        background: "#fff",
        display: "flex",
        ...
        boxShadow: "0 -4px 30px rgba(0,0,0,.08)",
        overflowY: "auto",
      }} className="show-sm" style={{ display: "none" }}>
        <style>{`
          @media (max-width: 640px) {
            .show-sm { display: flex !important; }
            .hide-sm { display: none !important; flex: 0 !important; }
          }
        `}</style>
